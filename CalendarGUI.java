...
public class CalendarGUI implements Runnable{
	...
	private JPanel createDatePanel() {
		...
		JButton previousYearButton = new JButton("tahun sebelumnya");
		...
		JButton previousMonthButton = new JButton("bulan sebelumnya");
		...
		JButton button = new JButton("Kalender sebenarnya");
		button.addActionListener(new CalendarListener());
		button.setFont(font);
		panel.add(button);
		
		JButton nextMonthButton = new JButton("bulan selanjutnya");
		...
		JButton nextYearButton = new JButton("tahun selanjutnya");
